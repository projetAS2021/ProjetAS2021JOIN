                      ...
                      children: [
                        ...
                        TextFieldRectangle(
                          ...
                          onValidated: (value) {
                            ...
                            } else if (!_co!.isValidEmail(value)) {
                        ...
                        TextFieldRectangle(
                          ...
                          onValidated: (value) {
                            if (value == null ||
                                value.isEmpty ||
                                value.length < 8) {
                              return 'Mot de passe incorrect ou trop court (8)';
                            } else {
                              mdp = value;
                            }
                          },
                        ...
                        SizedBox(height: 10),
                        TextFieldRectangle(
                          hintText: 'Code pour rejoindre un compte',
                          onSaved: (String? value) {
                            _co!.codeCompte = value;
                          },
                        ),
                        SizedBox(height: 10),
                        Row(
